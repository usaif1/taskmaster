...
//imports
import { CentralHeading, CentralSubheading, FormButton } from "components/common";
  ...
  return (
    <>
      ...
      <div className={classes.formContainer}>
        <CentralSubheading title={`${capitalize(subheading[0])}`} size={`2rem`} />
        <form className={classes.form} onSubmit={onSubmitHandler}>
          <div className={classes.inputContainer}>
            ...
            <FormButton text={"some text"}>
              {!loading ? capitalize(subheading[0]) : <ClipLoader color="#ffffff" size={10} />}
            </FormButton>
